...
async function transferTaskOwnership({ taskId, fromUserId, toUserId, clientIP }) {
    try {
        return await db.$transaction(async (tx) => {
            ...
            console.log('fromUserId (Requester):', fromUserId, 'Type:', typeof fromUserId);
            console.log('task.userId (Owner):', task.userId, 'Type:', typeof task.userId);
            ...
            console.log(`Transferring Task ID ${taskId} from User ID ${fromUserId} to User ID ${toUserId}`);
